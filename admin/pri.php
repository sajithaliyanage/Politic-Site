    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid" >
                        ...
                        <div class="row" style="margin-top:30px;">
                            <div class="row" style="margin-bottom:200px;">
                                <div class="col-xs-12">
                                    ...
                                    <form action="php/private.php" method="post" enctype="multipart/form-data">
                                        <center>
                                            <h2>Select PRIVATE Multiple images to Upload</h2>
                ...
                <a href="../privategallery.php"><button  class="btn btn-success btn-lg navbar-right">Go to the Website</button></a>
